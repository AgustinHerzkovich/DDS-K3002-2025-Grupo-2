...
// ApiResponse reutilizable para lista paginada de hechos
        ...
        // ============= ETIQUETAS =============
        paths.addPathItem("/etiquetas/index", new PathItem()
                .get(new Operation()
                        .tags(List.of("etiqueta-controller"))
                        .summary("Autocompletar etiquetas")
                        .description("Devuelve recomendaciones de etiquetas basadas en el texto de búsqueda. Útil para funcionalidad de autocompletado en formularios. Utiliza caché de 1 minuto para optimizar el rendimiento.")
                        .addParametersItem(new Parameter()
                                .name("search")
                                .in("query")
                                .required(true)
                                .schema(new StringSchema())
                                .description("Texto de búsqueda para filtrar etiquetas")
                        )
                        .addParametersItem(new Parameter()
                                .name("limit")
                                .in("query")
                                .required(false)
                                .schema(new IntegerSchema()._default(5))
                                .description("Número máximo de resultados a devolver (por defecto: 5)")
                        )
                        .responses(new ApiResponses()
                                .addApiResponse("200", new ApiResponse()
                                        .description("Lista de etiquetas sugeridas")
                                        .content(new Content()
                                                .addMediaType("application/json",
                                                        new MediaType()
                                                                .schema(new ArraySchema()
        ...
        // ============= CATEGORÍAS =============
        paths.addPathItem("/categorias/index", new PathItem()
                .get(new Operation()
                        .tags(List.of("categoria-controller"))
                        .summary("Autocompletar categorías")
                        .description("Devuelve recomendaciones de categorías basadas en el texto de búsqueda. Útil para funcionalidad de autocompletado en formularios. Utiliza caché de 1 minuto para optimizar el rendimiento.")
                        .addParametersItem(new Parameter()
                                .name("search")
                                .in("query")
                                .required(true)
