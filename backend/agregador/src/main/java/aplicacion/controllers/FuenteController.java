...
import aplicacion.services.schedulers.CargarFuentesScheduler;
...
public class FuenteController {
    ...
    private final CargarFuentesScheduler cargarFuentesScheduler;

    public FuenteController(FuenteService fuenteService, FuenteOutputMapper fuenteOutputMapper, CargarFuentesScheduler cargarFuentesScheduler) {
        this.fuenteService = fuenteService;
        this.fuenteOutputMapper = fuenteOutputMapper;
        this.cargarFuentesScheduler = cargarFuentesScheduler;
    }
    ...
    @PostMapping("/recargarFuentes")
    public ResponseEntity<Void> recargarFuentes() {
        cargarFuentesScheduler.cargarNuevasFuentes();
